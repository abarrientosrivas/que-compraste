...
class TestScraperFunctions(unittest.TestCase):
    ...
    def _test_scraper_valid(self):
        ...
        self.assertEqual(result['product_images'], ["https://images.pricely.ar/images/1/7790790120325.jpg"])
        time.sleep(11)
        ...
        self.assertEqual(result['product_images'], ["https://images.pricely.ar/images/1/7790310985465.jpg"])
        time.sleep(11)
